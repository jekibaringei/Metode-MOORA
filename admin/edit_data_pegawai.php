...
$data_sepatu = tampilpegawai("SELECT * FROM alternatif WHERE id_alternatif = '$id_alternatif' ")[0];
...
<body bgcolor="f0f0f0">
  ...
  <div class="container bg-light shadow p-3 mb-5">
    <div class="alert alert-info">
      <center><b>EDIT DATA SEPATU SPORT</b></center>
    </div>
