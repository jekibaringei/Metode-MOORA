...
<body bgcolor="f0f0f0">
  ...
  <br>
  <a href="tambah_data_pegawai.php" class="btn btn-success">Tambah Data</a>
  <br><br>
  <div class="hitung">
    ...
    <table class="table table-striped shadow p-3 mb-5">
      ...
      <?php foreach ($data_pegawai as $pegawai) { ?>
        <tr>
          ...
          <td><?= $pegawai['c5']; ?></td>
          <td><?= $pegawai['c6']; ?></td>
          <td><a href="edit_data_pegawai.php?id_alternatif=<?= $pegawai['id_alternatif']; ?>" class="btn btn-warning">Edit</a> <a href="hapus_data_pegawai.php?id_alternatif=<?= $pegawai['id_alternatif']; ?>" class="btn btn-danger">Delete</a></td>
        </tr>
